...
void ModelAnimator::SetModel(shared_ptr<Model> model)
{
	...
	const vector<shared_ptr<Material>>& materials = _model->GetMaterials();
...
void ModelAnimator::CreateAnimationTramsform(uint32 index)
{
